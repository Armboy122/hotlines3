...
function DrawerOverlay({
  ...
  return (
    <DrawerPrimitive.Overlay
        ...
        className={cn(
        "data-[state=open]:animate-in data-[state=closed]:animate-out data-[state=closed]:fade-out-0 data-[state=open]:fade-in-0 fixed inset-0 z-[60] bg-slate-950/50 backdrop-blur-sm overscroll-contain",
        className
      )}
      {...props}
    />
  ...
  return (
    <DrawerPortal data-slot="drawer-portal">
      ...
      <DrawerPrimitive.Content
        ...
        className={cn(
          "group/drawer-content fixed z-[60] flex h-auto flex-col border-white/70 bg-white/90 shadow-2xl shadow-blue-950/15 backdrop-blur-xl",
