...
interface TaskDailyFormStableProps {
...
export default function TaskDailyFormStable({
  jobTypes,
  jobDetails,
  feeders,
  teams,
}: TaskDailyFormStableProps) {
  ...
  const jobDetailOptions = filteredJobDetails.map((jd) => ({
    ...
    <div className="max-w-7xl mx-auto px-3 sm:px-4 lg:px-6 py-4 sm:py-6">
      <Card className="card-glass overflow-hidden">
        <CardHeader className="bg-gradient-to-r from-emerald-500 via-emerald-600 to-teal-600 text-white p-6 sm:p-8 relative overflow-hidden">
          ...
          <p className="text-center text-emerald-100 text-sm mt-2 relative z-10">
            (เวอร์ชันเสถียร)
          </p>
        </CardHeader>
