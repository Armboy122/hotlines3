...
assert.equal(buildGoogleMapsSearchUrl(13.756331, 100.501762), 'https://www.google.com/maps/search/?api=1&query=13.756331,100.501762')
assert.equal(buildGoogleMapsDirectionsUrl(13.756331, 100.501762), 'https://www.google.com/maps/dir/?api=1&destination=13.756331,100.501762')
...
const operationTasks = [
  ...
  task({ id: 103, assignedTeamId: 7, sequence: 2, pointLabel: 'N-002', status: 'blocked' }),
  task({ id: 104, assignedTeamId: 7, sequence: 1, pointLabel: 'N-001', status: 'in_progress', workDetail: 'ตัดกิ่งไม้', latitude: 13.1, longitude: 100.1, startedAt: '2026-05-13T09:00:00Z' }),
